...
<body>
	...
	<script type="text/javascript">
		...
		var sunrise = new Date().sunrise(52.16, 4.49);
		var sunset = new Date().sunset(52.16, 4.49);
		console.debug("Sunrise at: \n"+sunrise+"\n\nSunset at: \n"+sunset);

		// Check if current moment is outside of sunrise and sunset
		var night = !moment().isBetween(sunrise, sunset);
